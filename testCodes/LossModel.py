...
class YOLOLossV1(nn.Module):
    ...
    def forward(self, pred_tensor, target_tensor):
        ...
        coord_not_active_mask = torch.ones(bboxes_target.size()[0], dtype=torch.uint8)
        coord_active_mask.zero_()
        # coord_not_active_mask[:] = 1
        # print(coord_not_active_mask, coord_not_active_mask.dtype)
        # exit()
